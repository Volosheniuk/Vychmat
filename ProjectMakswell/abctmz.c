...
void abcInit(Grid *g) {
	...
	ezLeft = (double*)calloc(SizeY * 6, sizeof(double));
	ezRight = (double*)calloc(SizeY * 6, sizeof(double));
	ezTop = (double*)calloc(SizeX * 6, sizeof(double));
	ezBottom = (double*)calloc(SizeX * 6, sizeof(double));
